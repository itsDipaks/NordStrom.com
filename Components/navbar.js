function navbar(){
      ...
      <div id="middlediv">
        ...
        <div id="searchbar"><input type="search" /></div>

        
        <div id="signup"><a href="">SignUp ^</a>
          <ul class="signupmenu">
          <div   id="create"> <a href="signup1.html">Create Accaount/Login</a></div>
        <hr>
          <h4><a id="name" href="profile.html"> Your Account</a></h4>
         <hr>
               ...
               <a href=""><i class="fa-solid fa-store"></i><span>Your Store</span></a>
               <a href=""><i class="fa-solid fa-id-badge"></i><span>Profile</span></a>
       
               <div id="signoutdiv"><button id="signout">SignOut</button></div>
      ...
      <ul id="categoriesdiv">
        <li>
          ...
          <ul class="salemenu1">
            <ul>
              <header>Women</header>
              <li><a href="#"></a>New Markdowns</li>
              <li><a href="#"></a>Clothing</li>
              <li><a href="#"></a>Shoes</li>
              <li><a href="#"></a>Handbags & Wallets</li>
              ...
              <li><a href="#"></a>Plus</li>
              <li><a href="#"></a>Petite</li>
              <li><a href="#"></a>Maternity</li>
              <li><a href="#"></a>Juniors</li>
            </ul>
            ...
            <ul>
              ...
              <li><a href="#"></a>Shoes</li>
              <li><a href="#"></a>Accessories</li>
              <li><a href="#"></a>Grooming & Cologne</li>
              <li><a href="#"></a>Contemporary</li>
              <li><a href="#"></a>Designer</li>
              <li><a href="#"></a>Designer</li>
            ...
            <ul>
              ...
              <li><a href="#"></a>Boys</li>
              <li><a href="#"></a>Baby Sale Clothing, Shoes & Accessories</li>
              <li><a href="#"></a>Baby Gear & Essentials</li>
              <li><a href="#"></a>Shoes</li>
            </ul>
            <ul>
              <header>Home</header>
              <li><a href="#"></a>Bedding & Bath</li>
              <li><a href="#"></a>Home Decor</li>
              <li><a href="#"></a>Electronics & Tech Accessories</li>
              <li><a href="#"></a>Luggage & Travel</li>
              <li><a href="#"></a>Tabletop & Kitchen</li>
            ...
            <ul>
              ...
              <li><a href="#"></a>Women</li>
              <li><a href="#"></a>Men</li>
              <li><a href="#"></a>Gender Inclusive</li>
        ...
        <li><a href="#">Women</a>
          ...
          <ul class="women">
            <ul>
              ...
              <li><a href="">Blazers, Suits & Separates</a></li>
              <li><a href="">Coats & Jackets</a></li>
              <li><a href="">Dresses</a></li>
              <li><a href="">Jeans & Denim</a></li>
              <li><a href="">Lingerie, Hosiery & Shapewear</a></li>
            ...
            <ul>
              ...
              <li><a href="">Experience Fine Jewelry</a></li>
        ...
        <li><a href="#">Men</a>
         <ul class="men">
          ...
          <ul>
            <header>Clothing</header>
            <li><a href="product2.html">Activewear</a></li>
            <li><a href="product2.html">Blazers & Sport Coats</a></li>
            <li><a href="product2.html">Coats & Jackets</a></li>
            <li><a href="product2.html">Dress Shirts</a></li>
            <li><a href="product2.html">Jeans</a></li>
            <li><a href="product2.html">Joggers & Sweatpants</a></li>
            <li><a href="product2.html">Lounge, Pajamas & Robes</a></li>
            <li><a href="product2.html">Pants</a></li>
          ...
          <ul>
            <header>Grooming & Cologne</header>
            <li><a href="">Body Care & Deodorant</a></li>
            <li><a href="">Cologne</a></li>
            <li><a href="">Dopp Kits & Toiletry Bags</a></li>
...
function navbarall(){
      ...
      <div id="middlediv">
        ...
        <div id="signup"><a href="">SignUp ^</a>
          <ul class="signupmenu">
          <div><button> <a href="signup1.html">Create Accaount/Login</a></button></div>
...
export {navbar ,navbarall ,navbarlog}
